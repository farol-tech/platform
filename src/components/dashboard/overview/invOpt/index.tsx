...
const InvOpt: React.FC<Props> = ({ data, hasButton = true }) => {
    return (
        <div className="inline-flex h-[579px] w-[551px] flex-col items-start justify-start gap-5 p-2.5">
            <div className="text-neutral-900 text-center font-['Ubuntu'] text-2xl font-medium">Otimização de Inventário</div>
